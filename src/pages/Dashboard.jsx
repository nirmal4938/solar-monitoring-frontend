...
export const Dashboard = () => {
  ...
  return (
    <div className="grid p-4 gap-0">
      {/* HEADER */}

      <div className="col-12 flex justify-content-between align-items-center mb-4">
        <div className="flex align-items-center gap-2">
          <BarChart3 size={20} className="text-500" />
          <h2 className="m-0 font-semibold text-xl">Energy Overview</h2>
        </div>
      ...
      <div className="col-12 p-2">
        <Card className="border-round-xl border-1 surface-border shadow-1">
          ...
          <div className="grid text-center mb-2 gap-0">
          ...
          <div style={{ height: "360px" }}>
            <Chart type="line" data={generationVsLoad} options={chartOptions} />
          </div>
        </Card>
      </div>
      ...
      <div className="col-12 md:col-6 p-2">
        <Card className="border-round-xl border-1 surface-border shadow-1">
          ...
          <div style={{ height: "260px" }}>
            <Chart type="doughnut" data={gridInteraction} />
          </div>
        </Card>
      </div>
